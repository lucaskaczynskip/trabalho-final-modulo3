...
public class RequestRepository {
    ...
    public RequestRepository() {
        ...
        list.add(new Request(COUNTER.incrementAndGet(), "Cai e quebrei minha clavicula", "Estava andando de bicicleta, quando cai numa vala, e com isso quebrei minha clavicula, a cirurgia é cara e atualmente não tenho dinheiro, preciso de ajuda para poder voltar a pedalar e me quebrar mais.", 12000.0, 0.0, 2, 4));
    }
